...
baseJS.fn.lightbox = function(cls) {
	...
	function Lightbox() {
		...
		var _this,_window,_parent,_bg,_content,_include,_caption,_prev,_next,_height,_counter,_current;
		...
		function set() {
			...
			_parent.css("top",_window.scrollTop()).height(winHeight);
			_content.css("top",(winHeight - _content.height()) / 2);
	...
	$("a[href^=#]").each(function() {
		...
		if (rel != "nonScroll") {
			...
			target.on("click",function() {
				...
				$("html,body").animate({ scrollTop:goal }, speed, "easeOutCubic");
